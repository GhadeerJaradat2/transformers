...
print("softmax iterate input, changable step size")
"""PyTorch BERT model."""
...
class BertSelfAttention(nn.Module):
    ...
    def forward(
        ...
        n_values = torch.zeros(reshaped_tensor.size(0), 7)  # Shape: (number of rows, 7)
        for i, row in enumerate(reshaped_tensor):
            ...
            for value in row:
                if (first ==0):
                    ...
                    if (value > max_value):
                        ...
                        if 0 < diff2 < 1:
                            n7,n6,n5,n4,n3,n2,n1 = n7,n6,n5,n4,n3,n2, n1+1
                        elif 1 <= diff2 < 2:
                            n7,n6,n5,n4,n3,n2,n1 = n7+n6,n5,n4,n3,n2,n1,1
                        elif 2 <= diff2 < 3:
                            n7,n6,n5,n4,n3,n2,n1 = n7+n6+n5,n4,n3,n2,n1,0,1
                        elif 3 <= diff2 < 4:
                            n7,n6,n5,n4,n3,n2,n1 = n7+n6+n5+n4,n3,n2,n1,0,0,1
                        elif 4 <= diff2 < 5:
                            n7,n6,n5,n4,n3,n2,n1 =  n7+n6+n5+n4+n3,n2,n1,0,0,0,1
                        elif 5 <= diff2 < 6:
                            n7,n6,n5,n4,n3,n2,n1 = n7+n6+n5+n4+n3+n2,n1,0,0,0,0,1
                        else:
                            n7,n6,n5,n4,n3,n2,n1 = n7+n6+n5+n4+n3+n2+n1,0,0,0,0,0,1
            ...
            n_values[i] = torch.tensor([n1, n2, n3, n4, n5, n6, n7])
        ...
        multipliers = torch.tensor([ np.exp(-0.5), np.exp(-1.5), np.exp(-2.5),np.exp(-3.5),np.exp(-4.5),np.exp(-5.5),np.exp(-6)])
